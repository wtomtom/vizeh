...
std::string HelpMessage(HelpMessageMode mode)
{
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), "vizeed.pid"));
#endif
    ...
    strUsage += HelpMessageOpt("-anonymizevizeeamount=<n>", strprintf(_("Keep N PIV anonymized (default: %u)"), 0));
...
// ********************************************************* Step 8: load wallet
    ...
    nAnonymizevizeeAmount = GetArg("-anonymizevizeeamount", 0);
    if (nAnonymizevizeeAmount > 999999) nAnonymizevizeeAmount = 999999;
    if (nAnonymizevizeeAmount < 2) nAnonymizevizeeAmount = 2;
